    ...
    <div class="row">
      <div class="col-md-12">
        ...
        <form action="controller/add_controller.jsp">
            <h1>User Name:</h1><input class="input_text" type="text" name="user_name">
            <h1>Password:</h1><input class="input_text" type="text" name="password">
            <h1>Name In Game</h1><input class="input_text" type="text" name="name_in_game">
<!--            <h1>Gender</h1><input class="input_text" type="text" name="gender">-->
            <h1>Phone</h1><input class="input_text" type="text" name="phone">
            <h1>Star_amount</h1><input class="input_text" type="text" name="star_amount">
            <div class="mt-6 text-center"><input class="btn btn-primary profile-button" type="submit" value="Insert"></div>
        </form>
