<%-- 
    Document   : Home
    Created on : Apr 22, 2023, 4:08:31 AM
    Author     : PC
--%>
...
<!--                    <td><%=obj_User_Bean.getPassword()%></td>-->
                    <td><%=obj_User_Bean.getName_in_game()%></td>
                    <td><%=obj_User_Bean.getPhone()%></td>
                    <td><%=obj_User_Bean.getStar_amount()%></td>
                    <td>
                        <a href="controller/delete_controller.jsp?user_id=<%=obj_User_Bean.getUser_id()%>" >
                        <input class="btn btn-primary profile-button" type="submit" value="Delete">
                        </a>
                    </td>
                    <td>
                        <div class="col-md-6">
                            <a href="edit.jsp?user_id=<%=obj_User_Bean.getUser_id()%>">
...
%>
            ...
            <div class="mt-6 text-center">
                <a href="add.jsp">
                <button class="btn btn-primary profile-button" type="button"> Add Profile </button>
                </a>
            </div>
